...
describe Being do
  ...
  context 'people' do
    ...
    before :each do
      @adam = FactoryGirl.create(:being, :name => 'Adam', surname: 'Man', :gender => 'male')
      @eve = FactoryGirl.create(:being, :name => 'Eve', surname: 'Man', :gender => 'female')
      @adam.marry @eve
    ...
    it 'gets the last name of the parent' do
      @baby = FactoryGirl.create(:being, name: 'Baby', surname: 'Baby')
      @adam.adopt @baby
